const DICTIONARY = {
    de: {
        ...
        'board.day.decrease': 'Tag verringern',
        'board.day.increase': 'Tag erhöhen',
        'board.edition': 'Edition',
        'board.empty': 'Aktiviere Spieler in der Seitenleiste, um sie auf dem Board hinzuzufügen.',
        'board.lock': 'Board sperren',
        'board.ping-filter': 'Ping-Filter',
        'board.ping-filter.empty': 'Noch keine Pings erfasst.',
        'board.ping-filter.shared': 'Doppel-Claim: {role}',
        ...
        'settings.customRoles': 'Eigene Rollenauswahl',
        'settings.customRoles.reset': 'Auswahl zurücksetzen',
        'settings.fabled': 'Fabelwesen',
        'settings.fabled.add': '+ Fabelwesen hinzufügen',
        'settings.fabled.remove': 'Fabelwesen entfernen',
        'settings.glossary.bluff': 'Bluffvorschläge',
        'settings.glossary.demon': 'Dämonen',
        'settings.glossary.hints': 'Tipps',
        'settings.glossary.minion': 'Schergen',
        'settings.glossary.outsider': 'Außenseiter',
        'settings.glossary.townsfolk': 'Bürger',
        'settings.glossary.traveller': 'Reisende',
        'settings.lorics': 'Lorics',
        'settings.lorics.add': '+ Loric hinzufügen',
        'settings.lorics.remove': 'Loric entfernen',
        'settings.tab.glossary': 'Glossar',
    ...
    en: {
        ...
        'board.day.decrease': 'Decrease day',
        'board.day.increase': 'Increase day',
        'board.edition': 'Edition',
        'board.empty': 'Activate players in the sidebar to add them to the board.',
        'board.lock': 'Lock board',
        'board.ping-filter': 'Ping filter',
        'board.ping-filter.empty': 'No pings recorded yet.',
        'board.ping-filter.shared': 'Double claim: {role}',
        ...
        'settings.customRoles': 'Custom role selection',
        'settings.customRoles.reset': 'Reset selection',
        'settings.fabled': 'Fabled',
        'settings.fabled.add': '+ Add Fabled',
        'settings.fabled.remove': 'Remove Fabled',
        'settings.glossary.bluff': 'Bluff suggestions',
        'settings.glossary.demon': 'Demons',
        'settings.glossary.hints': 'Hints',
        'settings.glossary.minion': 'Minions',
        'settings.glossary.outsider': 'Outsiders',
        'settings.glossary.townsfolk': 'Townsfolk',
        'settings.glossary.traveller': 'Travellers',
        'settings.lorics': 'Lorics',
